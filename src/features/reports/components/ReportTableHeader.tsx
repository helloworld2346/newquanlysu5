...
const th =
  "border border-white/20 bg-red-800 dark:bg-red-900 text-center align-middle px-1 text-sm font-semibold text-white";
const thV =
  "border border-white/20 bg-red-800 dark:bg-red-900 text-center align-middle px-1 py-2 text-sm font-semibold text-white";
